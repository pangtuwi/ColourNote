...
class HomeLastActivityViewController: UIViewController, UITableViewDataSource {
    ...
    func displayData () {
        ...
        if let activity = ActivityRecords.instance.getLatestActivity() {
...
extension HomeLastActivityViewController {
